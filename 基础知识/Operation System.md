...
> * 多进程的程序相对来说更加健壮，一个进程的退出一般不会影响其它进程；而多线程程序中，如果一个程序崩了，整个进程都会死掉。
...
## 死锁与饥饿
> * **死锁**：在一组进程中，每一个进程都在无限等待另一个进程占有的进程，而导致所有进程都无法运行，这种现象就叫出现死锁。
